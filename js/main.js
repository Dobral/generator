// Функция генерации pdf страницы с параметрами (смотри html2pdf)
...
//Вешаем на чекбокс событие, принажатии прячем блок с шаблоном или показываем его
